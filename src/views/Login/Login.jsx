        ...
        <div id="carouselExampleIndicators" className="carousel slide" data-ride="carousel">
          <div className="carousel-inner">
            ...
            <div className="carousel-item">
              <img className="d-block w-100" src={DevC} alt="Second slide" />
            </div>
            <div className="carousel-item">
              <img className="d-block w-100" src={DevC} alt="Third slide" />
            </div>
            <div className="carousel-item">
              <img className="d-block w-100" src={DevC} alt="Forth slide" />
            </div>
            <div className="carousel-item">
