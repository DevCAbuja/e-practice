                            ...
                            <div className="signin">
                                <div className="signup-form">
                                    <form autoComplete="off">
                                        <h1>Sign Up</h1>
                                        <div className="icon">
                                            <img alt="facebook_signup" src="https://img.icons8.com/color/48/000000/facebook-circled.png" />
                                            <img alt="google_signup" src="https://img.icons8.com/color/48/000000/google-logo.png" />
                                        </div>
                                        <div className="input-group">
                                            <img src={UserNameIcon} alt="ui" />
                                            <input className="input" type="text" htmlFor="username" placeholder="john doe" autoComplete="false" />
                                        </div>
                                        <br />
                                        <div className="input-group">
